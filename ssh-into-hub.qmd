...
This functionality is enabled with the use of [`jupyter-sshd-proxy`](https://github.com/yuvipanda/jupyter-sshd-proxy), which is pre-installed in the NASA-Openscapes default environment. Much of this documentation is adapted from the `jupyter-sshd-proxy` documentation.
...
When you are logged into your JupyterHub server via SSH or in a terminal in JupyterLab, `~` refers to your home directory on the JupyterHub server.
